...
import com.example.libroai.book_list;
import com.example.libroai.liberary_item;
import com.example.libroai.liberary_list;
import com.example.libroai.liberay_book;
import com.example.libroai.manage_books;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardmanagebooks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, manage_books.class));
            }
        });
        ...
        cardDelivery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, com.example.libroai.DeliveryActivity.class));
            }
        });
        ...
        cardAddBook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, liberay_book.class));
            }
        });
    }
